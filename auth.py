...
def signup(username, password, confirm_password, security_question, security_answer):
    """
    ...
    user_id = db.create_user(username, password_hash, security_question, answer_hash)
    log_in_user(user_id)
    return user_id
